...
class PostListingResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        if($this->broker_id){
            return [
                ...
                'ownership'                 => $this->broker_id == auth($request->input('activeGuard'))->user()->id ? 1 : null,
            ...
            return [
                ...
                'ownership'                 => $this->developer_id == auth($request->input('activeGuard'))->user()->id ? 1 : null,
                'is_favourite'              => $favourite ? 1 : null,
                'status'                    => $this->status ? new StatusResource($this->status):null,
                'reason'                    => $this->reason ? new ReasonResource($this->reason):null,
                'reasonOption'              => $this->reasonOption ? new ReasonOptionResource($this->reasonOption):null,
            ...
            return [
                ...
                'ownership'                 => $this->individual_id == auth($request->input('activeGuard'))->user()->id ? 1 : null,
                'is_favourite'              => $favourite ? 1 : null,
                'status'                    => $this->status ? new StatusResource($this->status):null,
                'reason'                    => $this->reason ? new ReasonResource($this->reason):null,
                'reasonOption'              => $this->reasonOption ? new ReasonOptionResource($this->reasonOption):null,
