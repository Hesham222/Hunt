<x-admin::layout>
 <x-slot name="pageTitle">Post | Edit</x-slot name="pageTitle">
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form enctype="multipart/form-data" method="POST" action="{{route('admins.post.update', $record->id)}}"
                      ...
                      <div class="m-portlet__body">
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  <label>Creator/Individual:</label>
                                     <ul>
                              ...
                              <div class="col-lg-6">
                                  <label>Reason:</label>
                                  <input type="text" disabled value="{{ $record->reason->reason}}" class="form-control">
                                    @if($record->reasonOption)
                                      <input type="text" disabled value="{{ $record->reasonOption->option}}" class="form-control">
                                    @endif
                              </div>
                          </div>
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  <label>Status:</label>
                                  <select name="post_status_id" required=""
                                          class="form-control m-input m-input--square"
                                          id="exampleSelect1">
                                      @foreach($statuses as $status)
                                          <option @if(old('post_status_id ')== $status->id || $status->id==$record->post_status_id  ) selected @endif
                              ...
                              <div class="col-lg-6">
                                  ...
                                  <select name="post_completion_id" required=""
                                          class="form-control m-input m-input--square"
                                          id="exampleSelect1">
                                      @foreach($completions as $completion)
                                          <option @if(old('post_completion_id')== $completion->id || $completion->id==$record->post_completion_id) selected @endif
                                          value="{{ $completion->id}}">{{ $completion->completion }}
                                          </option>
                                      @endforeach
                                  </select>
                                  @error('post_completion_id')
                                  <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                                  @enderror
                          ...
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  <label>City:</label>
                                  <select data-area="{{$record->area_id}}" name="city_id" id="city_id" required=""
                                          class="form-control m-input m-input--square"
                                          id="exampleSelect1">
                          ...
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  ...
                                  <select name="post_type_id" required=""
                                      ...
                                      @foreach($types as $type)
                                          <option @if(old('post_type_id')== $type->id || $type->id==$record->post_type_id) selected @endif
                              ...
                              <div class="col-lg-6">
                                  <label>Sale:</label>
                                  <select name="post_sale_id" required=""
                                          class="form-control m-input m-input--square"
                                          id="exampleSelect1">
                                      @foreach($sales as $sale)
                                          <option @if(old('post_sale_id')== $sale->id || $sale->id==$record->post_sale_id) selected @endif
                          ...
                          <div class="form-group m-form__group row">
                              ...
                              <div class="col-lg-6">
                                  ...
                                  <textarea
                                      ...
                                      required=""
                                      class="form-control m-input"
                                      placeholder="Enter Description..." >{{old('description')?old('description'):$record->description}}</textarea>
                                  @error('description')
                                  <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
  ...
  <x-slot name="scripts">
    ...
    <script>
        $('#city_id').change(function(){
            ...
            $.ajax({
                type:'get',
                url:"{{route('admins.post.append.areas')}}",
