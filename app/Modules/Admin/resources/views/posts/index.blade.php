...
@if(request()->input('view')=='trash')
  <x-slot name="pageTitle">Post | Trash</x-slot name="pageTitle">
  @section('posts-trash-active', 'm-menu__item--active')
@elseif(request()->input('view')=='request')
  <x-slot name="pageTitle">Post | Requests</x-slot name="pageTitle">
  @section('posts-request-active', 'm-menu__item--active')
@else
  <x-slot name="pageTitle">Post | View</x-slot name="pageTitle">
  @section('posts-view-active', 'm-menu__item--active')
@endif
        ...
        <div class="m-portlet m-portlet--mobile">
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Admin::posts.components.filterForm')
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('admins.post.data',['view' => request()->input('view',0),'individual' => request()->input('individual',0),'post' => request()->input('post',0)]) !!}");
        /**
