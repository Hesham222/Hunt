...
@if(request()->input('view')=='trash')
  <x-slot name="pageTitle">Cities | Trash</x-slot name="pageTitle">
  @section('cities-trash-active', 'm-menu__item--active')
@else
  <x-slot name="pageTitle">Cities | View</x-slot name="pageTitle">
  ...
  <x-slot name="style">
    ...
    <!-- Start page content -->
      ...
      <div class="alert alert-danger alert-dismissible fade show" role="alert" style="font-weight: bold;">
                @if(request()->input('view')=='view')
                    Remember, Moving any city to the trash, we will move all realated areas to the trash automatically.
                @else
                    Remember, Deleting/Restoring any city, we will delete/restore all related areas automatically.
                @endif
        ...
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__head-tools">
              <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                  <a href="{{route('admins.city.create')}}"
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Admin::cities.components.filterForm')
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('admins.city.data',['view' => request()->input('view',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('admins.city.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
        });
    });
  </script>
  <!-- external JS -->
