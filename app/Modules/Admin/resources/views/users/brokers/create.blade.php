<x-admin::layout>
 <x-slot name="pageTitle">Brokers | Create</x-slot name="pageTitle">
 @section('brokers-active', 'm-menu__item--active m-menu__item--open')
 @section('brokers-create-active', 'm-menu__item--active')
  <x-slot name="style">
  <!-- Some styles -->
    <style>
        .invalid-feedback {
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form enctype="multipart/form-data" method="POST" action="{{route('admins.broker.store')}}"
