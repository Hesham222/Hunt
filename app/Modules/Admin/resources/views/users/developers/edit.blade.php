<x-admin::layout>
 <x-slot name="pageTitle">Developers | Edit</x-slot name="pageTitle">
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form enctype="multipart/form-data" method="POST" action="{{route('admins.developer.update', $record->id)}}"
                      ...
                      <div class="m-portlet__body">
                          ...
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  ...
                                  <input
                                      type="text"
                                      value="{{old('developer_name')?old('developer_name'):$record->developer_name}}"
                                      name="developer_name"
                                      required=""
                                      class="form-control m-input"
