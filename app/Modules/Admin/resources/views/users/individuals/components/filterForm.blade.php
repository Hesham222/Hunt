<form  method="GET"  action="{{route('admins.individual.export')}}" id="filterDataForm">
  ...
  <div style="display: flex;justify-content: flex-end;align-items:flex-end;margin-bottom: 20px">
    ...
    <div class="input-group" style="width: 50%">
      <input type="text" name="value" id="searchField" placeholder="search key..." class="form-control" aria-label="Text input with dropdown button">
