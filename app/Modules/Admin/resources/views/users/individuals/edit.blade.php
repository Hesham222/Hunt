<x-admin::layout>
 <x-slot name="pageTitle">Individuals | Edit</x-slot name="pageTitle">
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form enctype="multipart/form-data" method="POST" action="{{route('admins.individual.update', $record->id)}}"
