<form  method="GET"  action="{{route('admins.listing.export')}}" id="filterDataForm">
<input type="hidden" name="view" value="{{ request()->input('view',0)}}">
<input type="hidden" name="developer" value="{{ request()->input('developer',0)}}">
<input type="hidden" name="broker" value="{{ request()->input('broker',0)}}">
